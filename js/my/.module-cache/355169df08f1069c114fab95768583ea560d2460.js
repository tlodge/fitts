define(['jquery','react', 'showdown'], function($, React, Showdown){
	...
	var ResultsBox = React.createClass({displayName: "ResultsBox",
		...
		handleExperimentSelected: function(experiment){
			...
			if (idx != -1){
				currentExperiment = this.experiments[idx];
				this.setState({experiment:currentExperiment});
			} 
		},
		...
		render: function(){
			return(
				React.createElement("div", {className: "btn-group", role: "group"}, 
					...
					React.createElement("button", {type: "button", className: "btn btn-default"}, "Email this experiment")
				)
			)
		}
	});
